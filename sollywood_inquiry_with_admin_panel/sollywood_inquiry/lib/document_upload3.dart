...
class DocumentUpload3 extends StatefulWidget {
  const DocumentUpload3({Key? key}) : super(key: key);

  @override
  _DocumentUpload3State createState() => _DocumentUpload3State();
}

class _DocumentUpload3State extends State<DocumentUpload3> {
  ...
  Future _uploadFile(String path) async {
    ...
    Fluttertoast.showToast(
        msg: "Aadhaar Card Photo uploaded successfully",
