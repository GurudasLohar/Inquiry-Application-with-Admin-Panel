...
class DocumentUpload6 extends StatefulWidget {
  const DocumentUpload6({Key? key}) : super(key: key);

  @override
  _DocumentUpload6State createState() => _DocumentUpload6State();
}

class _DocumentUpload6State extends State<DocumentUpload6> {
  ...
  Future _uploadFile(String path) async {
    ...
    Fluttertoast.showToast(
        msg: "Bank Details Photo uploaded successfully",
