...
class DocumentUpload2 extends StatefulWidget {
  const DocumentUpload2({Key? key}) : super(key: key);

  @override
  _DocumentUpload2State createState() => _DocumentUpload2State();
}

class _DocumentUpload2State extends State<DocumentUpload2> {
  ...
  Future _uploadFile(String path) async {
    ...
    Fluttertoast.showToast(
        msg: "Passport Photo uploaded successfully",
