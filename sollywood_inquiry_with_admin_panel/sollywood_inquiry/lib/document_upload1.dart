...
class DocumentUpload1 extends StatefulWidget {
  const DocumentUpload1({Key? key}) : super(key: key);

  @override
  _DocumentUpload1State createState() => _DocumentUpload1State();
}

class _DocumentUpload1State extends State<DocumentUpload1> {
  ...
  Future _uploadFile(String path) async {
    ...
    Fluttertoast.showToast(
        msg: "Full size photo uploaded successfully",
