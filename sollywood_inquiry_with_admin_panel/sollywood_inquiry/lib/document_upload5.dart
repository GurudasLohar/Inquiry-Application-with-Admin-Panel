...
class DocumentUpload5 extends StatefulWidget {
  const DocumentUpload5({Key? key}) : super(key: key);

  @override
  _DocumentUpload5State createState() => _DocumentUpload5State();
}

class _DocumentUpload5State extends State<DocumentUpload5> {
  ...
  Future _uploadFile(String path) async {
    ...
    Fluttertoast.showToast(
        msg: "Family Photo uploaded successfully",
